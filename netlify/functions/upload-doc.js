...
На примере:
- В пятом пункте удостоверения есть строка вроде "AF000488684" — это СЕРИЯ+НОМЕР ВУ целиком.
...
Нужно:
- "license_series" — ТОЛЬКО буквенная серия, например "AF". Никаких цифр, никакого "UZ"/"UZB".
- "license_number" — ТОЛЬКО цифровая часть номера из этой же строки, например "000488684".
- "license_full" — полный код серии+номера ВУ как на документе, например "AF000488684" (буквы+цифры, без пробелов).
...

{
  ...
  "fields": {
    // для vu_front:
    // для vu_front:
    "license_series": "Только буквенная серия ВУ, как на документе (например \"AF\"), без цифр, без UZ/UZB, или null",
    "license_number": "Только цифры номера ВУ (например \"000488684\"), без букв и пробелов, или null",
    "license_full": "Полный код серии+номера ВУ как на документе (например \"AF000488684\"), буквы+цифры, без пробелов, или null",
