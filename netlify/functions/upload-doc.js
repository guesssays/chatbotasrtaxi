...
ОЧЕНЬ ВАЖНО:
- ВСЕ текстовые поля (ФИО, адрес, названия и т.п.) нужно возвращать ровно в том алфавите и написании, как на документе.
- НЕЛЬЗЯ переводить или транслитерировать:
  • не заменяй латиницу на кириллицу и наоборот;
  • не переводь имена на русский или другой язык;
  • не исправляй орфографию и не "нормализуй" текст.
- Если на документе ФИО написано латиницей — в поле "driver_name" тоже должна быть латиница, символ в символ.
`
...
ОЧЕНЬ ВАЖНО:
- "owner_name" и "owner_address" нужно возвращать ровно в том алфавите и написании, как на документе.
- НЕЛЬЗЯ переводить латиницу в кириллицу и наоборот, нельзя менять язык, исправлять орфографию или "нормализовать" текст.
`
...

{
  ...
  "fields": {
    ...
    "driver_name": "ФИО полностью РОВНО как на документе, без перевода/транслитерации, или null",
    ...
    "plate_number": "госномер, как на документе (например \\"01Y984SB\\") или null",
     "owner_name": "ФИО владельца РОВНО как на документе, без перевода/транслитерации, или null",
